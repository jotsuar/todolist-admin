...
<?php if ($wannaUseSession): ?>
				$this->Session->setFlash(__('The data have been saved correctly'), 'flash_success');
				$this->redirect(array('action' => 'index'));
<?php else: ?>
				$this->flash(__('The data have been saved correctly'), array('action' => 'index'));
<?php endif; ?>
			} else {
<?php if ($wannaUseSession): ?>
				$this->Session->setFlash(__('Error saving, please try later'), 'flash_error');
<?php endif; ?>
			}
		}
<?php
...
<?php if ($wannaUseSession): ?>
			$this->Session->setFlash(__('Deleted successfully'), 'flash_success');
			$this->redirect(array('action' => 'index'));
<?php else: ?>
			$this->flash(__('Deleted successfully'), array('action' => 'index'));
<?php endif; ?>
		}
<?php if ($wannaUseSession): ?>
		$this->Session->setFlash(__('Error when deleting, please try later'), 'flash_error');
<?php else: ?>
		$this->flash(__('Error when deleting, please try later'), array('action' => 'index'));
<?php endif; ?>
		$this->redirect(array('action' => 'index'));
	}<?php echo "\n" ?>
